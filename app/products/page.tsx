...
export const metadata: Metadata = {
  ...
  description:
    "Field-proven spill control solutions including mobile spill kits, absorbents, and bio-remediation agents. Fast-acting, economical, and in line with environmental regulations.",
  keywords: [
    "spill kits",
    "absorbent products",
    "spill containment",
  ...
  alternates: {
    canonical: "https://sssksolutions.co.za/products",
  },
};
