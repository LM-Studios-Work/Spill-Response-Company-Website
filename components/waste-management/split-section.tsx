        ...
        <div className="max-w-xl mx-auto lg:mx-0">
          ...
          <ul className="space-y-6">
            <li className="flex items-start">
              <span className="material-icons text-accent mr-4 mt-1">
                oil_barrel
              </span>
              <div>
                ...
                <span className="text-gray-300 text-sm">
                  Diesel and oil spills, contaminated rags, and filters.
                </span>
              </div>
            </li>
            <li className="flex items-start">
            ...
            <li className="flex items-start">
              ...
              <div>
                ...
                <span className="text-gray-300 text-sm">
                  Soil binders, hazardous absorbents, and containers.
                </span>
              </div>
            </li>
            <li className="flex items-start">
