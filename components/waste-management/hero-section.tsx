  ...
  return (
    <header className="relative bg-secondary h-[500px] flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image
          src="/waste.webp?height=500&width=1200"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="lg:w-2/3">
          <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-6">
            Industrial Waste Management <br className="hidden lg:block" />&
            Hazardous Waste Disposal
          </h1>
          <p className="text-xl text-gray-200 mb-8 max-w-2xl leading-relaxed">
            Environmentally responsible, cost-effective, and operationally
            efficient industrial waste management and hazardous waste disposal
            services for industries in Gauteng, South Africa.
          </p>
