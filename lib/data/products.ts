...
export const products: Product[] = [
  {
    ...
    shortDescription:
      "Heavy-duty chemical absorbent mat rolls for aggressive chemical and solvent spills.",
    longDescription:
  ...
  },
  {
    ...
    shortDescription:
      "Hydrophobic absorbent pillow that absorbs oil and repels water — ideal for wet environments.",
    longDescription:
...

  {
    ...
    shortDescription:
      "Heavy-duty universal absorbent roll for oils, coolants, water, and mild chemicals.",
    longDescription:
    ...
    specifications: [
      {
        label: "Application",
        value: "Universal — Oil, Water, Coolant, Mild Chemical",
      },
  ...
  },
  {
    ...
    shortDescription:
      "Versatile absorbent pads for everyday spill control of oils, coolants, and water-based fluids.",
    longDescription:
    ...
    specifications: [
      {
        label: "Application",
        value: "Universal — Oil, Water, Coolant, Chemical",
      },
      { label: "Material", value: "Meltblown Polypropylene" },
      { label: "Colour", value: "Grey" },
